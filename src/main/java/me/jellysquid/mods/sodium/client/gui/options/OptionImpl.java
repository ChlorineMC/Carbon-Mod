...
public class OptionImpl<S, T> implements Option<T> {
    ...
    public static class Builder<S, T> {
        ...
        public Builder<S, T> setName(IChatComponent name) {
        ...
        public Builder<S, T> setName(String name) {
            return setName(new ChatComponentText(name));
        }

        public Builder<S, T> setTooltip(IChatComponent tooltip) {
        ...
        public Builder<S, T> setTooltip(String tooltip) {
            return setTooltip(new ChatComponentText(tooltip));
        }
